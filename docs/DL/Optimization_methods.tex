...
\PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} v1.4}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{update\PYZus{}parameters\PYZus{}with\PYZus{}adam}\PY{p}{(}\PY{n}{parameters}\PY{p}{,} \PY{n}{grads}\PY{p}{,} \PY{n}{v}\PY{p}{,} \PY{n}{s}\PY{p}{,} \PY{n}{t}\PY{p}{,} \PY{n}{learning\PYZus{}rate} \PY{o}{=} \PY{l+m+mf}{0.01}\PY{p}{,}
    ...
    \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Update parameters using the Adam optimization algorithm.}

\PY{l+s+sd}{    Arguments:}
\PY{l+s+sd}{    parameters \PYZhy{}\PYZhy{} python dictionary containing your parameters:}
\PY{l+s+sd}{                    parameters[\PYZsq{}W\PYZsq{} + str(l)] = Wl}
\PY{l+s+sd}{                    parameters[\PYZsq{}b\PYZsq{} + str(l)] = bl}
\PY{l+s+sd}{    grads \PYZhy{}\PYZhy{} python dictionary containing your gradients for each parameter:}
\PY{l+s+sd}{                    grads[\PYZsq{}dW\PYZsq{} + str(l)] = dWl}
\PY{l+s+sd}{                    grads[\PYZsq{}db\PYZsq{} + str(l)] = dbl}
\PY{l+s+sd}{    v \PYZhy{}\PYZhy{} Adam variable, moving average of the first gradient, maintained as a python dictionary}
\PY{l+s+sd}{    s \PYZhy{}\PYZhy{} Adam variable, moving average of the squared gradient, maintained as a python dictionary}
\PY{l+s+sd}{    t \PYZhy{}\PYZhy{} Adam variable, counts the number of steps taken for bias correction}
\PY{l+s+sd}{    learning\PYZus{}rate \PYZhy{}\PYZhy{} learning rate, scalar}
...
\PY{l+s+sd}{    epsilon \PYZhy{}\PYZhy{} hyperparameter to prevent division by zero in the Adam update, a small scalar}

\PY{l+s+sd}{    Returns:}
\PY{l+s+sd}{    parameters \PYZhy{}\PYZhy{} python dictionary containing your updated parameters}
\PY{l+s+sd}{    v \PYZhy{}\PYZhy{} updated Adam variable, moving average of the first gradient, python dictionary}
\PY{l+s+sd}{    s \PYZhy{}\PYZhy{} updated Adam variable, moving average of the squared gradient, python dictionary}
\PY{l+s+sd}{    v\PYZus{}corrected \PYZhy{}\PYZhy{} python dictionary containing bias\PYZhy{}corrected first moment estimates}
\PY{l+s+sd}{    s\PYZus{}corrected \PYZhy{}\PYZhy{} python dictionary containing bias\PYZhy{}corrected second moment estimates}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
...
Run the following code to see how the model does Adam and learning rate
decay.
