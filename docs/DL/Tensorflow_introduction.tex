...
\PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} v3.1}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{one\PYZus{}hot\PYZus{}matrix}\PY{p}{(}\PY{n}{label}\PY{p}{,} \PY{n}{C}\PY{o}{=}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Computes the one hot encoding for a single label}
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Arguments:}
\PY{l+s+sd}{        label \PYZhy{}\PYZhy{}  (int) Categorical labels}
\PY{l+s+sd}{        C \PYZhy{}\PYZhy{}  (int) Number of different classes that label can take}
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Returns:}
\PY{l+s+sd}{         one\PYZus{}hot \PYZhy{}\PYZhy{} tf.Tensor A one\PYZhy{}dimensional tensor (array) with the one hot encoding.}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{c+c1}{\PYZsh{} (approx. 1 line)}
    \PY{c+c1}{\PYZsh{} one\PYZus{}hot = None(None(None, None, None), shape=[C, ]) }
    \PY{c+c1}{\PYZsh{} YOUR CODE STARTS HERE}
...
\PY{k}{def} \PY{n+nf}{one\PYZus{}hot\PYZus{}matrix\PYZus{}test}\PY{p}{(}\PY{n}{target}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{C} \PY{o}{=} \PY{l+m+mi}{4}
    \PY{n}{result} \PY{o}{=} \PY{n}{target}\PY{p}{(}\PY{n}{label}\PY{p}{,} \PY{n}{C}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test 1:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{result}\PY{p}{)}
    \PY{k}{assert} \PY{n}{result}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{==} \PY{n}{C}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Use the parameter C}\PY{l+s+s2}{\PYZdq{}}
    ...
    \PY{n}{result} \PY{o}{=} \PY{n}{target}\PY{p}{(}\PY{n}{label\PYZus{}2}\PY{p}{,} \PY{n}{C}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test 2:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{result}\PY{p}{)}
    \PY{k}{assert} \PY{n}{result}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{==} \PY{n}{C}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Use the parameter C}\PY{l+s+s2}{\PYZdq{}}
    \PY{k}{assert} \PY{n}{np}\PY{o}{.}\PY{n}{allclose}\PY{p}{(}\PY{n}{result}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{0.} \PY{p}{,}\PY{l+m+mf}{1.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{]} \PY{p}{)}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Wrong output. Use tf.reshape as instructed}\PY{l+s+s2}{\PYZdq{}}
...
You will not apply ``softmax'' here. You'll see below, in
\texttt{Exercise\ 6}, how the computation for it can be done internally
by TensorFlow.
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{c+c1}{\PYZsh{}(approx. 5 lines)                   \PYZsh{} Numpy Equivalents (NumPy not to be used. Use TF API):}
...
\item
  You skipped applying ``softmax'' in \texttt{Exercise\ 5} which will
  now be taken care by the
  \texttt{tf.keras.losses.categorical\_crossentropy} by setting its
  parameter \texttt{from\_logits=True} (You can read the response by one
  of our mentors
  \href{https://community.deeplearning.ai/t/week-3-assignment-compute-total-loss-try-to-set-from-logits-false/243049/2?u=paulinpaloalto}{here}
  in the Community for the mathematical reasoning behind it. If you are
  not part of the Community already, you can do so by going
  \href{https://www.coursera.org/learn/deep-neural-network/ungradedLti/ZE1VR/important-have-questions-issues-or-ideas-join-our-community}{here}.)
\end{itemize}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} GRADED FUNCTION: compute\PYZus{}total\PYZus{}loss }

\PY{k}{def} \PY{n+nf}{compute\PYZus{}total\PYZus{}loss}\PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{n}{labels}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Computes the total loss}
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Arguments:}
...
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Returns:}
\PY{l+s+sd}{    total\PYZus{}loss \PYZhy{} Tensor of the total loss value}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    
    \PY{c+c1}{\PYZsh{}(1 line of code)}
    \PY{c+c1}{\PYZsh{} remember to set `from\PYZus{}logits=True`}
    \PY{c+c1}{\PYZsh{} total\PYZus{}loss = ...}
    \PY{c+c1}{\PYZsh{} YOUR CODE STARTS HERE}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{compute\PYZus{}total\PYZus{}loss\PYZus{}test}\PY{p}{(}\PY{n}{target}\PY{p}{,} \PY{n}{Y}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{assert} \PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{abs}\PY{p}{(}\PY{n}{result} \PY{o}{\PYZhy{}} \PY{p}{(}\PY{l+m+mf}{0.50722074} \PY{o}{+} \PY{l+m+mf}{1.1133534}\PY{p}{)} \PY{o}{/} \PY{l+m+mf}{2.0}\PY{p}{)} \PY{o}{\PYZlt{}} \PY{l+m+mf}{1e\PYZhy{}7}\PY{p}{)}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test 1 does not match. Did you get the reduce sum of your loss functions?}\PY{l+s+s2}{\PYZdq{}}
    
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Test 2}
    \PY{n}{labels} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{constant}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mf}{1.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{1.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{1.}\PY{p}{]}\PY{p}{]}\PY{p}{)}
    \PY{n}{logits} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{constant}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mf}{1.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{1.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{1.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{,} \PY{l+m+mf}{0.}\PY{p}{]}\PY{p}{]}\PY{p}{)}
    
    \PY{n}{result} \PY{o}{=} \PY{n}{compute\PYZus{}total\PYZus{}loss}\PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{n}{labels}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test 2: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{result}\PY{p}{)}
    \PY{k}{assert} \PY{n}{np}\PY{o}{.}\PY{n}{allclose}\PY{p}{(}\PY{n}{result}\PY{p}{,} \PY{l+m+mf}{3.295837} \PY{p}{)}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test 2 does not match.}\PY{l+s+s2}{\PYZdq{}}
    
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}033}\PY{l+s+s2}{[92mAll test passed}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{n}{compute\PYZus{}total\PYZus{}loss\PYZus{}test}\PY{p}{(}\PY{n}{compute\PYZus{}total\PYZus{}loss}\PY{p}{,} \PY{n}{new\PYZus{}y\PYZus{}train} \PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{verbatim}
    ...
    \textbf{Note:} When using sum of losses for gradient computation, it's
important to reduce the learning rate as the size of the mini-batch
increases. This ensures that you don't take large steps towards minimum.
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{k}{for} \PY{n}{epoch} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}epochs}\PY{p}{)}\PY{p}{:}
        ...
        \PY{n}{epoch\PYZus{}total\PYZus{}loss} \PY{o}{=} \PY{l+m+mf}{0.}
        ...
        \PY{k}{for} \PY{p}{(}\PY{n}{minibatch\PYZus{}X}\PY{p}{,} \PY{n}{minibatch\PYZus{}Y}\PY{p}{)} \PY{o+ow}{in} \PY{n}{minibatches}\PY{p}{:}
            ...
            \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{GradientTape}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{tape}\PY{p}{:}
                ...
                \PY{n}{minibatch\PYZus{}total\PYZus{}loss} \PY{o}{=} \PY{n}{compute\PYZus{}total\PYZus{}loss}\PY{p}{(}\PY{n}{Z3}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{transpose}\PY{p}{(}\PY{n}{minibatch\PYZus{}Y}\PY{p}{)}\PY{p}{)}
            ...
            \PY{n}{trainable\PYZus{}variables} \PY{o}{=} \PY{p}{[}\PY{n}{W1}\PY{p}{,} \PY{n}{b1}\PY{p}{,} \PY{n}{W2}\PY{p}{,} \PY{n}{b2}\PY{p}{,} \PY{n}{W3}\PY{p}{,} \PY{n}{b3}\PY{p}{]}
            \PY{n}{grads} \PY{o}{=} \PY{n}{tape}\PY{o}{.}\PY{n}{gradient}\PY{p}{(}\PY{n}{minibatch\PYZus{}total\PYZus{}loss}\PY{p}{,} \PY{n}{trainable\PYZus{}variables}\PY{p}{)}
            ...
            \PY{n}{epoch\PYZus{}total\PYZus{}loss} \PY{o}{+}\PY{o}{=} \PY{n}{minibatch\PYZus{}total\PYZus{}loss}
        
        \PY{c+c1}{\PYZsh{} We divide the epoch total loss over the number of samples}
        \PY{n}{epoch\PYZus{}total\PYZus{}loss} \PY{o}{/}\PY{o}{=} \PY{n}{m}
        ...
        \PY{k}{if} \PY{n}{print\PYZus{}cost} \PY{o}{==} \PY{k+kc}{True} \PY{o+ow}{and} \PY{n}{epoch} \PY{o}{\PYZpc{}} \PY{l+m+mi}{10} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{:}
            \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Cost after epoch }\PY{l+s+si}{\PYZpc{}i}\PY{l+s+s2}{: }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}} \PY{p}{(}\PY{n}{epoch}\PY{p}{,} \PY{n}{epoch\PYZus{}total\PYZus{}loss}\PY{p}{)}\PY{p}{)}
            ...
            \PY{n}{costs}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{epoch\PYZus{}total\PYZus{}loss}\PY{p}{)}
